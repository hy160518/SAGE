...
class EntityRegistry:
    ...
    DETERMINISTIC_THRESHOLD = 1.0  # Level 1: Exact match
    SEMANTIC_THRESHOLD = 0.85      # Level 2: Semantic similarity
    CROSS_MODAL_THRESHOLD = 0.75   # Level 3: Cross-modal alignment
    ...
    def __init__(self):
        ...
        self.match_history = []  # Track all matching decisions
    ...
    def register_entity(self, entity_data: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
        ...
        # Level 1: Deterministic Matching (exact match on strong identifiers)
        if phone:
        ...
        # Level 2: Semantic Matching (name similarity)
        if name:
        ...
        # Level 3: Cross-Modal Alignment (multiple field matching)
